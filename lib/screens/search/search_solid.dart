...
import 'package:aliifa/screens/profil_user.dart';
...
class Search2 extends StatefulWidget {
  ...
  @override
  State<Search2> createState() => _Onboar3State();
}

class _Onboar3State extends State<Search2> {
  @override
  void initState() {
    super.initState();
  }
String _searchQuery = '';  var currnts = 0;
  ...
  Future<List<SOLID>> fetchAllProducts(BuildContext context) async {
    ...
    solidList = solidList.where((solid) => solid.name!.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
  }
    return solidList;
  }
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              children: [
                                                                IconButton(
                                                                  onPressed:
                                                                      () {Profile4(phone:petDataa.user_phone.toString() ,
                                                                          uid: petDataa
                                                                              .user_id
                                                                              .toString(),
                                                                          name_user: petDataa
