...
class Food extends StatefulWidget {
  @override
  State<Food> createState() => _Onboar3State();
}

class _Onboar3State extends State<Food> {
  @override
  void initState() {
    super.initState();
  }
        ...
        onSuccess: () async {
          ...
          if (decoded["status"] == "successful") {
            ...
            for (int i = 0; i < data.length; i++) {
              ...
              SOLID solid = SOLID.fromJson(item); // create a new pet object
              solid.type = type; // set the pet type
              solidList.add(solid); // add the pet to the list
            }
          } else {
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    Profile4(
                                                      phone: petDataa.user_phone
                                                          .toString(),
                                                      uid: petDataa.user_id
                                                          .toString(),
                                                      name_user: petDataa
                                                          .user_name
                                                          .toString(),
