...
class Profile3 extends StatefulWidget {
  ...
  const Profile3({Key? key, required this.uid, required this.name_user,required this.phone,})
      : super(key: key);
  @override
  State<Profile3> createState() => _Onboar3State();
}

class _Onboar3State extends State<Profile3> {
  var currnts = 0;
        ...
        onSuccess: () async {
          ...
          if (decoded["status"] == "successful") {
            ...
            for (int i = 0; i < data.length; i++) {
              ...
              // add the pet to the list if the user_id matches the id of the currently logged in user
              if (pet.user_id == widget.uid) {
...
if (Navigator.canPop(context)) {
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (selectedType.isNotEmpty) {
                   ...
                   petList.sort((a, b) => a.date_added!.compareTo(b.date_added!));
  ...
  overflow: TextOverflow.clip, // أو TextOverflow.ellipsis
