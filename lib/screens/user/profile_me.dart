...
class Profile2 extends StatefulWidget {
  ...
  @override
  State<Profile2> createState() => _Onboar3State();
}

class _Onboar3State extends State<Profile2> {
      ...
      onSuccess: () async {
        ...
        if (decoded["status"] == "successful") {
          ...
          for (int i = 0; i < data.length; i++) {
            ...
            if (pet.user_id == userProvider.user.id) {
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              ,
                                                               Container(
                    child: Text(
                  petDataa.date_added != null ? DateFormat('MMMM d, y').format(DateTime.parse(petDataa.date_added!)) : '',
                  style: TextStyle(
                  fontSize: 18.0,
                  fontWeight: FontWeight.bold,
                  ),
