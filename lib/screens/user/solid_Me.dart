...
class Foodprofil extends StatefulWidget {
  const Foodprofil({Key? key}) : super(key: key);
  @override
  State<Foodprofil> createState() => _Onboar3State();
}

class _Onboar3State extends State<Foodprofil> {
  @override
  void initState() {
    super.initState();
  }
        ...
        onSuccess: () async {
         ...
         List<dynamic> data = decoded["data"];
            for (int i = 0; i < data.length; i++) {
              ...
              solid.type = type; 
               if (solid.user_id == userProvider.user.id) {
              solidList.add(solid); }
            }
          } else {
